...
public class TriangleUtilitiesTest {
    ...
    public void getTriangleTest1() {
        String expected =
                        ...
                        "********\n" +
                        "*********\n";
        String actual = TriangleUtilities.getTriangle(9); //did not match expected string
        Assert.assertEquals(expected, actual);
    }
    ...
    public void getTriangleTest2() {
        String expected =
                        ...
                        "***\n" +
                        "****\n";
        String actual = TriangleUtilities.getTriangle(4); //did not match expected string
        Assert.assertEquals(expected, actual);
    }
